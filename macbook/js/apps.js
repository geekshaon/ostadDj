...
function promocode(){
  let promo = document.getElementById('input-field').value
  console.log(promo)
  if(promo==="ostad"){
    let mytotal = document.getElementById('user-payment').innerHTML
    mytotalint = parseInt(mytotal)
    let distotal= mytotalint- (mytotalint*0.1)
    document.getElementById('user-payment').innerHTML = distotal
